...
print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=0.1), '(lambda = 0.1)')
print('Linear Regression test_error =', run_linear_regression_on_MNIST(lambda_factor=0.01), '(lambda = 0.01)')
...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    train_y, test_y = update(train_y, test_y)
    test_error_mod3 = compute_test_error(test_x, test_y, theta, temp_parameter)
    return test_error_mod3


print('softmax test_error_mod3=', run_softmax_on_MNIST(temp_parameter=1))
